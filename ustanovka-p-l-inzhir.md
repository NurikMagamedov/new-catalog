...
5\. **Сделать копию базы!**

6\. Обновить конфигурацию

7\. Войти в программу и проверить, чтобы все вкладки системы открывались без ошибок. Сформировать отчеты ДДС, ОПиУ и Баланс чтобы тоже сформировались без ошибок.