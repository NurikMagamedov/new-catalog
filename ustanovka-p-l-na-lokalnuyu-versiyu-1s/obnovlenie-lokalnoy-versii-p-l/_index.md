...
2. В открывшемся окне вы можете увидеть **номер текущей версии (1)**, **список новых версий** **(2)**, **описание изменений** в новой версии **(3).**  **ВЫБЕРИТЕ САМЫЙ ВЕРХНИЙ (ПОСЛЕДНИЙ) релиз.** Для продолжения нажмите кнопку «**Далее**».
