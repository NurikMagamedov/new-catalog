...
4. **Модуль отчета ХЛ\_ОтчетДвижениеДенежныхСредств**, необходимо удалить пароль.

5. **Модуль отчета ХЛ\_ОтчетПлатежныйКалендарь**, необходимо удалить пароль.

6. **Модуль отчета ХЛ\_Взаиморасчеты**, необходимо удалить пароль.

7. Обработка 	**ХЛ\_ФормированиеАктовСчетов,** очистить процедуру ОтправитьПоЭлектроннойПочтеНаСервере().

   ![](./_index-9.png){width=526px height=108px}

8. Документ **ХЛ\_ОтчетБаланс**, удалить все процедуры на форме элемента.

9. Общая форма **ХЛ\_ФормаНастройки**, очистить  процедуру ЗарегистрироватьВебХукНаСервере().
